...
export function OG_KICKER_BY_SECTION(p) {
  ...
  if (p === "/cw-audio-course/") return "Audio course";
  ...
  if (p === "/es/te-quiero-en-codigo-morse/") return "Te quiero";
  if (p === "/es/aprender-codigo-morse/") return "Aprender Morse";
...
export const OG_PAGES = new Set([
  ...
  "/blog/how-to-write-your-name-in-morse-code/",
  "/blog/who-invented-morse-code/",
  "/blog/how-to-call-cq-morse-code/",
  "/blog/how-to-read-morse-code/",
  ...
  "/es/te-quiero-en-codigo-morse/",
  "/es/aprender-codigo-morse/",
